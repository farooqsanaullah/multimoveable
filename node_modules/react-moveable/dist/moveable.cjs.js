...
function caculateMatrixStack(target, container, prevMatrix, prevN) {
  ...
  while (el && !isEnd) {
    ...
    matrixes.push(getAbsoluteMatrix(matrix$1, n, origin), matrix.createOriginMatrix([hasNotOffset ? el : offsetLeft - el.scrollLeft, hasNotOffset ? origin : offsetTop - el.scrollTop], n));
  ...
  dragControl: function (moveable, e) {
    ...
    if (parentScale) {
      ...
      if (keepRatio && offsetWidth && offsetHeight) {
        ...
        var ratioRad = matrix.getRad([0, 0], [offsetWidth, offsetHeight]);
